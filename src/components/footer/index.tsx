import { companyLinks, contactItems, formInputs } from "@/src/constants/footer";
import { ContactItem, FormInput } from "@/src/types/footer";
          ...
          <form className="bg-[#1A1A1A] p-4 rounded-2xl">
            ...
            <div className="mb-4">
              <textarea 
                ...
                rows={4} // Make sure rows is a number
              ></textarea>
            </div>
            <button 
              type="submit" 
